...
import ovh.eukon05.lokit.common.dto.response.ApiErrorDTO;
...
public class GlobalRestExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDTO> handleDeviceNotFound(DeviceNotFoundException exception, HttpServletRequest request) {
        ApiErrorDTO errorDTO = buildErrorResponse(request, HttpStatus.NOT_FOUND, exception.getMessage(), Collections.emptyMap());
